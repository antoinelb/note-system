...
`adr/2026-07-template-import-from-root.md` already fixed the contract the `World` must honour: the vault is the typst root, and notes import `/templates/template.typ` root-absolute.
