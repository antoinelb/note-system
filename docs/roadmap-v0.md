...
- The only goal is building the note system (`adr/2026-07-goal-build-only.md`) — Claude writes the implementation, Antoine directs and decides (`adr/2026-08-implementation-is-claudes-job.md`).
